...
/**
 * This class aims to deal with the window that handles getting the project speakers
 *
 * @author Miren, Leire and Amanda
 * @version 1
 */
public class ProjectSpeakersController implements Controller {

    private MainGUI speakersWin;
    ...
    public void initializeInformation()  {
        try {
            ...
            Vector<String> rs = businessLogic.getSpeakers();
